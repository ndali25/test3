...
filename = strcat(saveFolder,'/Fig8a3_HD_FP1_',priorName);
...
filename = strcat(saveFolder,'/Fig8b3_DC_all_',priorName);
print(hFig, filename, '-dpdf','-r0')
