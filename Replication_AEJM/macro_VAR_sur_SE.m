...
res_sur = bvarGLP_y0(data, p, 'noc',0,'sur', 1, 'mcmc', 1, 'MCMCconst', 200, 'MNalpha',0,'MNpsi',0,'pos', iid, 'Ndraws', draws*1+ndDisc, 'Ndrawsdiscard', ndDisc, 'hyperpriors', 0,'y0_custom',y0_bar); % ,'pos', [1,2,3,4]
...
%% Fig 8 a 1: HD top 3
% Historical decompositions short - top 1
...
filename = strcat(saveFolder,'/Fig8a1_HD_FP1_',priorName);
...
filename = strcat(saveFolder,'/Fig8b1_DC_all_',priorName);
print(hFig, filename, '-dpdf','-r0')
