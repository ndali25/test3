...
filename = strcat(saveFolder,'/Fig8a2_HD_FP1_',priorName);
...
filename = strcat(saveFolder,'/Fig8b2_DC_all_',priorName);
print(hFig, filename, '-dpdf','-r0')
